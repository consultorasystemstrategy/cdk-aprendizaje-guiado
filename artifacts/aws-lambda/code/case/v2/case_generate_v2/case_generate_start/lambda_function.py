...
CASE_GENERATE_WORKER_LAMBDA = os.environ["CASE_GENERATE_WORKER_LAMBDA"]
...
def _validate_body(body: dict):
    ...
    if missing_fields:
        return f"Campos requeridos faltantes: {missing_fields}"
    ...
    for competencia in competencias:
        ...
        if not all(
            ...
            return (
                ...
                "'CompetenciaId', 'Competencia' y 'Capacidades'."
            )
        ...
        if not isinstance(capacidades, list) or len(capacidades) == 0:
            return (
                "El campo 'Capacidades' dentro de cada competencia "
        ...
        for capacidad in capacidades:
            ...
            if not all(
                ...
                return (
                    ...
                    "'CapacidadId', 'Capacidad' y 'Criterios'."
                )
            ...
            if not isinstance(criterios, list) or len(criterios) == 0:
                return (
                    "El campo 'Criterios' dentro de cada capacidad "
                    "debe ser una lista no vacía."
                )
            ...
            for criterio in criterios:
                ...
                if not all(
                    ...
                    return (
                        ...
                        "'CriterioId', 'Criterio' y 'CamposTematicos'."
                    )
                ...
                if not isinstance(campos, list) or len(campos) == 0:
                    return (
                        "El campo 'CamposTematicos' dentro de cada criterio "
                        "debe ser una lista no vacía."
                    )
                ...
                for campo in campos:
                    ...
                    if not all(
                        ...
                        return (
                            "Cada campo temático debe contener "
                            "'CampoTematicoId' y 'CampoTematico'."
                        )
...
def lambda_handler(event: Dict[str, Any], context: Any):
    ...
    try:
        logger.info(f"Event case generate start: {event}")
        ...
        lambda_client.invoke(
            FunctionName=CASE_GENERATE_WORKER_LAMBDA,
        ...
        return {
            ...
            "body": json.dumps(
                {
                    "success": True,
                    "message": "La generación del caso ha sido iniciada.",
                    "history_id": history_id
                }
            ),
        }
        ...
        logger.error(f"Error in case generate start: {e}", exc_info=True)
        ...
        return {
            ...
            "body": json.dumps(
                {
                    "success": False,
                    "message": "Error al iniciar la generación del caso.",
                }
            ),
        }