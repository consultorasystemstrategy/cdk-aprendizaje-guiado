...
# Secrets
secret_pinecone = SecretsHelper(f"{ENVIRONMENT}/{PROJECT_NAME}/{ENTERPRISE}/pinecone-api")
...
learning_path_table_helper = DynamoDBHelper(
    table_name=LEARNING_PATH_HISTORY_TABLE,
    pk_name="usuario_id",
    sk_name="date_time"
)
...
def _upload_ruta(usuario_id: int, silabo_id: int, unidad_id: int, sesion_id: int, prompt: str, ai_result: str, input_tokens: int, output_tokens: int):
    """
