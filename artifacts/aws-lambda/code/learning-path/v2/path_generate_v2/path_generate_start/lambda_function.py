...
PATH_GENERATE_WORKER_LAMBDA = os.environ["PATH_GENERATE_WORKER_LAMBDA"]
...
def lambda_handler(event: Dict[str, Any], context: Any):
    ...
    try:
        ...
        logger.info(f"Event path generate start: {event}")
        ...
        lambda_client.invoke(
            FunctionName=PATH_GENERATE_WORKER_LAMBDA,
        ...
        logger.error(f"Error in path generate start: {e}", exc_info=True)
